...
android {
    namespace = "com.irurueta.android.glutils.app"
    compileSdk = 36
...
sonar {
    properties {
        ...
        property("sonar.projectKey", "albertoirurueta_irurueta-android-glutils")
        property("sonar.projectName", "irurueta-android-glutils-${project.name}")
